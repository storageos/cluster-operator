...
var storageosupgradesResource = schema.GroupVersionResource{Group: "storageos.com", Version: "v1", Resource: "storageosupgrades"}
...
func (c *FakeStorageOSUpgrades) Get(name string, options v1.GetOptions) (result *storageosv1.StorageOSUpgrade, err error) {
	...
	return obj.(*storageosv1.StorageOSUpgrade), err
}
...
func (c *FakeStorageOSUpgrades) List(opts v1.ListOptions) (result *storageosv1.StorageOSUpgradeList, err error) {
	...
	list := &storageosv1.StorageOSUpgradeList{ListMeta: obj.(*storageosv1.StorageOSUpgradeList).ListMeta}
	for _, item := range obj.(*storageosv1.StorageOSUpgradeList).Items {
