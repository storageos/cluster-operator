...
func (s *Deployment) Delete() error {
	...
	if err := s.k8sResourceManager.RoleBinding(KeyManagementClusterBindingName, namespace, nil, nil, nil).Delete(); err != nil {
		return err
	}

	if err := s.k8sResourceManager.Role(KeyManagementClusterRoleName, namespace, nil, nil).Delete(); err != nil {
		return err
	}
