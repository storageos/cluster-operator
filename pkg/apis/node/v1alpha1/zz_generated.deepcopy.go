...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageOSAPI) DeepCopyInto(out *StorageOSAPI) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageOSAPI.
func (in *StorageOSAPI) DeepCopy() *StorageOSAPI {
	if in == nil {
		return nil
	}
	out := new(StorageOSAPI)
	in.DeepCopyInto(out)
	return out
}
