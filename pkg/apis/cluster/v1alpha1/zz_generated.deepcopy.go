...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageOSKVBackend) DeepCopyInto(out *StorageOSKVBackend) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageOSKVBackend.
func (in *StorageOSKVBackend) DeepCopy() *StorageOSKVBackend {
	if in == nil {
		return nil
	}
	out := new(StorageOSKVBackend)
	in.DeepCopyInto(out)
	return out
}
