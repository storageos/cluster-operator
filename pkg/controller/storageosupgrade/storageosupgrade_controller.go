...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileStorageOSUpgrade{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner StorageOSUpgrade
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &storageosv1alpha1.StorageOSUpgrade{},
	})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *storageosv1alpha1.StorageOSUpgrade) *corev1.Pod {
