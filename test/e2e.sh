...
main() {
    ...
    if [ "$2" = "olm" ]; then
        ...
        # fails with error:
        #       ERROR: crd spec.version not defined. [storageos/storageoscluster.crd.yaml]
        # The CRDs generated by the latest version of operator-sdk don't
        # contain that field. Operator-courier project seems to be inactive at
        # the moment.
